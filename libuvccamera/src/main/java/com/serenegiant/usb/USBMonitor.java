...
public class USBMonitor {
    ...
    private static final boolean DEBUG = true; //BuildConfig.DEBUG;    // TODO set false on production
    ...
    public interface OnDeviceConnectListener {
        ...
        void onAttach(HashSet<UsbDevice> needNotifyDevices);
...
//			if (DEBUG) Log.i(TAG, "unregister:");
        ...
        public void run() {
            ...
            if (mOnDeviceConnectListener != null && needNotifyDevices.size() > 0) {
                mListenerHandler.post(() -> {
                    ...
                    mOnDeviceConnectListener.onAttach(needNotifyDevices);
    ...
    private void showUsbList() {
        Dialog usbListDialog = new Dialog(mWeakContext.get());
